...
// 대신 UserDetails라는 "표준 인터페이스"로만 사용자 정보를 주고 받는다.
...
public class CustomUserDetails implements UserDetails {
    ...
    // DaoAuthenticationProvider가 passwordEncode.matches(사용자 입력, 이 값)으로 대조한다.
    @Override
    ...
    // ---- 이하 4개는 "계정 상태" 검사용 ----
    // 인증 과정에서는 비밀번호 대조 전 후에 호출되며, 하나라도 false면 로그인이 거부된다.
